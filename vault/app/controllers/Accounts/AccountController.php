	...
	public function submitNewAccount(){
		...
		if(Session::has('username') && Session::get('user_type')=="Root"){
			...
			if($validator->fails()){
				...
				$desc = "(".Session::get('user_type').") "."<strong>".Session::get('username')."</strong> has created a new <strong>".strtolower($user["user_type"])."</strong> account: <strong>".$user["username"]."</strong>.";
		...
		if(Session::has('username') && Session::get('user_type')=="Root"){
			...
			if($validator->fails()){
				...
				if(!$isChanged){
					...
					$desc = "(".Session::get('user_type').") "."<strong>".Session::get('username')."</strong> has updated <strong>".$user->username."'s</strong> account. These are the fields that have been modified : ".$changesMade.".";
