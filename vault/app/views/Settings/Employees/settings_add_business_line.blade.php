...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Add Business Line | Vault</title>
            ...
            <div class="main_contain">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
		                ...
		                @endif
		                {{ Form::open(array("method"=>"post","url"=>URL('settings/employees/submitnewbusinessline'))) }}
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    {{ Form::text('name','',array("class"=>"form-control","placeholder"=>"Business Line Name")) }}
                                                </div>
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ Form::button('Submit',array("class"=>"fright btn btn-sm btn-info",'onclick'=>"return confirm('Add new business line?')","type"=>"submit")) }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
