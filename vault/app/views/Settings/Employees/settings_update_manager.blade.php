...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Update Manager | Vault</title>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
		            	...
		            	<div class="alert alert-danger alert-dismissible text-center" role="alert">
			                ...
			                <strong>Manager Information Update Failed. </strong> {{ Session::get('message') }}
		                </div>
		                @endif
		                @if(Session::get('success'))
		            	<div class="alert alert-success alert-dismissible text-center" role="alert">
			                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
			                <strong>Manager Information Update Successful. </strong> {{ htmlentities(Session::get('success')) }}
		                </div>
		                @endif
		                @if(Session::get('info'))
		                ...
		                @endif
		                {{ Form::open(array("method"=>"post","url"=>URL('settings/employees/submitmanagerupdate'))) }}
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    {{ Form::text('last_name',$manager->last_name,array("class"=>"form-control","placeholder"=>"Last Name")) }}
                                                </div>
                                            </td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    <span class="input-group-addon">>></span>
                                                    {{ Form::text('first_name',$manager->first_name,array("class"=>"form-control","placeholder"=>"First Name")) }}
                                                </div>
                                            </td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ Form::button('Submit',array("class"=>"fright btn btn-sm btn-info",'onclick'=>"return confirm('Update manager information?')","type"=>"submit")) }}
                                            </td>
                                            <td></td>
                                        </tr>
                                    </tbody>
