<?php Session::put("page2",URL()."/assets/client/update/".$asset_key."/".$asset->id)?> 
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>Update Client Asset | Vault</title>
        ...
        <div class="main_contain">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="fright">
                        @if($asset->status=="For Repair" || $asset->status=="Retired")
                        <button type="button" onclick="parent.location='{{ URL() }}/assets/client/remarks/{{ $asset->id }}'" class="btn btn-sm btn-info">View Remarks</button>
                        @endif
                        <button type="button" onclick="parent.location='{{ URL() }}/assets/client/logs/{{ $asset->id }}'" class="btn btn-sm btn-info">View Logs</button>
                    </div>
	                    <h5>Update Client Asset @if($asset->status=="Lost") (This asset is marked as LOST) @endif</h5>
	                    ...
	                    @endif
                    	{{ Form::open(array("url"=>"assets/client/submitassetupdate","method"=>"post")) }}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-addon">>></span>
                                                {{ Form::text("charger",$asset->charger,array("class"=>"form-control input-sm","placeholder"=>"Charger Serial Number")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    @endif
                                    @if($asset->classification->url_key=="laptops" && $asset_name=="Laptops")
                                    <tr>
                                        <td><p style="float:right;font-weight:900">OS Image</p></td>
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-addon">>></span>
                                                <input type="text" disabled class="form-control" value="{{ !empty($asset->image) ? $asset->image : 'None.' }}"/>
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
                                                ...
                                                <span class="input-group-addon">>></span>
                                               	{{
                                                    Form::select("ram_upgrade",array(
                                                            ...
                                                            "6GB"=>"6GB",
                                                            "8GB"=>"8GB"),
                                                            $asset->laptop_ram_upgrade,array("class"=>"form-control input-sm"));
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                ...
                                                {{ Form::text("warranty_start",$asset->warranty_start,array("class"=>"form-control","id"=>"end-datepicker","placeholder"=>"Warranty Start Date")) }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <label for="start-datepicker" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
                                                {{ Form::text("warranty_end",$asset->warranty_end,array("class"=>"form-control","id"=>"start-datepicker","placeholder"=>"Warranty End Date")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                    </tr>
                                     <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-addon">>></span>
                                                {{ Form::select("location",$location,$asset->location,array("class"=>"form-control input-sm")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-addon">>></span>
                                                {{ Form::select("antivirus",$antivirus,$asset->antivirus,array("class"=>"form-control input-sm")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        @if($asset->status!="Lost")
	                                        @if($asset->classification->url_key=="laptops")
	                                        		{{
	                                                    Form::select("action",array(
	                                                            ""=>"--Select Action--",
	                                                            "update"=>"Update",
	                                                            "transfer"=>"Transfer Asset",
                                                            	"waiver"=>"Generate Waiver",
	                                                            "return"=>"Log as Returned",
	                                                            "lost"=>"Log as Lost",
	                                                            "image"=>"Add/Change Image",
	                                                            ),
	                                                            "update",array("class"=>"form-control input-sm","onchange"=>"waiver()","id"=>"choice"));
                                ...
                                <tbody>
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                {{
                                                    Form::select("asset_status",array(
                                                            ...
                                                            "Recruitment"=>"Recruitment",
                                                            "Retired"=>"Retired",
                                                            "Test Case"=>"Test Case"),$asset->status,array("class"=>"form-control input-sm","disabled"));
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <span class="input-group-addon">>></span>
                                                {{ Form::text("charger",$asset->charger,array("class"=>"form-control input-sm","placeholder"=>"Charger Serial Number","disabled")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
                                                ...
                                                <span class="input-group-addon">>></span>
                                               	{{
                                                    Form::select("ram_upgrade",array(
                                                            ...
                                                            "4GB"=>"4GB",
                                                            "8GB"=>"8GB"),
                                                            $asset->laptop_ram_upgrade,array("class"=>"form-control input-sm","disabled"));
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <label for="start-datepicker" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
                                                {{ Form::text("warranty_start",$asset->warranty_start,array("class"=>"form-control","id"=>"end-datepicker","placeholder"=>"Warranty Start Date","disabled")) }}
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group input-group-sm">
                                                <label for="start-datepicker" class="input-group-addon btn"><span class="glyphicon glyphicon-calendar"></span></label>
                                                {{ Form::text("warranty_end",$asset->warranty_end,array("class"=>"form-control","id"=>"start-datepicker","placeholder"=>"Warranty End Date","disabled")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                             <div class="input-group input-group-sm">
                                                <span class="input-group-addon">>></span>
                                                {{ Form::select("location",$location,$asset->location,array("class"=>"form-control input-sm","disabled")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
...
<script type="text/javascript">
    function redirector(){
        ...
        if(asset_id!="0"){
                parent.location="{{ URL() }}/assets/client/redirector/"+asset_id+"/update/{{ $asset->id }}";
        }
    }
    ...
    function waiver(){
		...
		if(choice=="waiver"){
			var win = window.open('{{ URL() }}/assets/client/generatewaiver/{{ $asset->classification->url_key }}/{{ $asset->id }}','_blank');
			win.focus;
		}
