        ...
        <div class="main_contain">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="fleft btn arrow-back"><a href="{{ URL() }}/assets/office/update/{{ $asset->classification->url_key }}/{{ $asset->id }}"><i class="fa fa-arrow-circle-o-left fa-3x"></i></a></div>
                    ...
                    @endif
                    {{ Form::open(array("url"=>"assets/office/transfer","method"=>"post")) }}
