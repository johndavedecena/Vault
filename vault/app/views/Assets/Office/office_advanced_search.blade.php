<?php Session::put('page',URL("assets/office/advancedsearch")."?page=".Input::get('page')); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>Advanced Search Office Assets | Vault</title>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active">    
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <!-- advanced search -->
                                    {{ Form::open(array("url"=>URL("assets/office/advancedsearch/search"),"method"=>"get","class"=>"form-horizontal")) }}
