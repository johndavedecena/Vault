...
<head>
    <meta charset="utf-8">
    <title>Add Office Asset | Vault</title>
        ...
        <div class="main_contain">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    @endif
                    {{ Form::open(array("method"=>"post","url"=>"assets/office/submitnewasset")) }}
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ Form::button('Submit',array("class"=>"fright btn btn-sm btn-info",'onclick'=>"return confirm('Add new office asset?')","type"=>"submit")) }}
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
...
<script type="text/javascript">
    function redirector(){
        ...
        if(asset_id!="0"){
                parent.location="{{URL()}}/assets/office/redirector/"+asset_id+"/add";
        }
    }
