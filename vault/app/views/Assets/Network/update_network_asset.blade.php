<?php Session::put("page2",URL()."/assets/network/update/".$asset_key."/".$asset->id)?> 
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>Update Network  Asset | Vault</title>
        ...
        <div class="main_contain">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="fright">
                        <button type="button" onclick="parent.location='{{ URL() }}/assets/network/logs/{{ $asset->id }}'" class="btn btn-sm btn-info">View Logs</button>
                    </div>
                    <h5>Update Network Asset @if($asset->status=="Lost") (This asset is marked as LOST) @endif</h5>
                    ...
                    @endif
                    {{ Form::open(array("url"=>"assets/network/submitassetupdate","method"=>"post")) }}
...
<script type="text/javascript">
    function redirector(){
        ...
        if(asset_id!="0"){
                parent.location="{{ URL() }}/assets/network/redirector/"+asset_id+"/update/{{ $asset->id }}";
        }
    }
</script>
</body>
