                    ...
                    <div class="tab-content">
                        <div class="tab-pane active">
                            <div class="col-md-4 fright checkbox-tab">
                                {{ Form::open(array("url"=>"assets/network/search/$asset_key","method"=>"post","class"=>"col-md-4 col-md-offset-4 navbar-form navbar-right fright","role"=>"search")) }}
                            ...
                            {{ Form::open(array("url"=>URL("assets/network/deleteassets"),"method"=>"post","onsubmit"=>"return checkedAnId()")) }}
                                <div class="row">
                                    <div class="col-md-4 checkbox-tab">
                                        ...
                                        <button class="btn btn-sm delete-employ" type="button" onclick="parent.location='{{ URL() }}/assets/network/add/{{ $asset_key }}'"><i class="fa fa-plus-circle fa-lg"></i> Add an Asset</button>
                                        @endif
                                        @if(Session::get('user_type')=="Root")
                                ...
                                <table class="table table-condensed table-striped table-hover">
                                    <thead>
                                        ...
                                        @endif
                                        <th width="10%"><p><a href="{{ URL().'/assets/network/search/'.$asset_key.'/'.urlencode($keyword).'/asset_tag/'}}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="asset_tag") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Asset Tag</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/search/'.$asset_key.'/'.urlencode($keyword).'/serial_number/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="serial_number") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Serial Number</p></th>
                                        <th width="15%"><p>Issued To</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/search/'.$asset_key.'/'.urlencode($keyword).'/model_id/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="model_id") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Model</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/search/'.$asset_key.'/'.urlencode($keyword).'/warranty_start/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="warranty_start") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Warranty Start</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/search/'.$asset_key.'/'.urlencode($keyword).'/warranty_end/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="warranty_end") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Warranty End</p></th>
                                        <th width="6%"><p>Status</p></th>
                                         <th width="10%"><p><a href="{{ URL().'/assets/network/view/'.$asset_key.'/location/'}}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="location") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Location</p></th>
                                        @else
                                        @if(Session::get('user_type')=="Root")
                                        <th width="10%"><p><span class="col-md-1 top-checkbox">{{ Form::checkbox('chk[]','',null,array("onchange"=>"toggle(this)","id"=>"checkbox1")) }}</span> Action</p></th>
                                        @else
                                        <th width="10%"><p>Action</p></th>
                                        @endif
                                        <th width="10%"><p><a href="{{ URL().'/assets/network/view/'.$asset_key.'/asset_tag/'}}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="asset_tag") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Asset Tag</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/view/'.$asset_key.'/serial_number/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="serial_number") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Serial Number</p></th>
                                        <th width="15%"><p>Issued To</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/view/'.$asset_key.'/model_id/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="model_id") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Model</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/view/'.$asset_key.'/warranty_start/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="warranty_start") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Warranty Start</p></th>
                                        <th width="12%"><p><a href="{{ URL().'/assets/network/view/'.$asset_key.'/warranty_end/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="warranty_end") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif Warranty End</p></th>
                                        <th width="6%"><p>Status</p></th>  
                                        <th width="10%"><p><a href="{{ URL().'/assets/network/view/'.$asset_key.'/location/'}}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="location") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Location</p></th>
                                        @endif
                                        </tr>
