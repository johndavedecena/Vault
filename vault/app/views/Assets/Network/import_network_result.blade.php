...
<head>
    <meta charset="utf-8">
    <title>Import Network Assets | Vault</title>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active">
                            ...
                            <div class="alert alert-danger alert-dismissible" role="alert">
                                ...
                                <strong>Import Failed. </strong> 0 rows have been saved to the database.
                            </div>
                            @elseif($fileHasError && $hasCorrectRows)
                            <section class="text-center"><h5>Import Partially Successful</h5></section>
                            <div class="alert alert-warning alert-dismissible" role="alert">
                                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <strong>Import Partially Successful. </strong> You have successfully updated the client assets database with {{ count($rowsWithErrors) }} error(s).
                            </div>
                            @elseif(!$fileHasError)
                            <section class="text-center"><h5>Import Successful</h5></section>
                            <div class="alert alert-success alert-dismissible" role="alert">
                                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <strong>Import Successful. </strong> You have successfully updated the cliet assets database without any errors.
                            </div>
                            @endif
                            @if($fileHasError)
