            ...
            <div class="main_contain">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        {{ Form::open(array('url'=>'accounts/addaccount','method'=>'post')) }}
                                ...
                                <table class="table table-condensed table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><br/>User Type</td>
                                            <td><br/>
                                            	{{ Form::select('user_type',array(""=>"--Select One--","Root"=>"Root Admin","Admin"=>"Admin","User"=>"User"),'',array("class"=>"form-control input-sm")) }}
