...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>All Employees | Vault</title>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                <div class="col-md-4 fright checkbox-tab">
                                    {{ Form::open(array("url"=>"employees/search","method"=>"post","class"=>"col-md-4 col-md-offset-4 navbar-form navbar-right fright","role"=>"search")) }}
                                ...
                                <table class="table table-condensed table-striped table-hover">
                                    <thead>
                                        ...
                                        @if(isset($intent) && $intent=="search")<!-- <input type="checkbox" onchange="toggle(this)" name="chk[]"/> -->
                                            ...
                                            @endif
                                            <th width="12%"><p><a href="{{ URL().'/employees/search/'.urlencode($keyword).'/employee_number/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="employee_number") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif Employee #</p></th>
                                            <th width="10%"><p><a href="{{ URL().'/employees/search/'.urlencode($keyword).'/status/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="status") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Status</p></th>
                                            <th width="13%"><p><a href="{{ URL().'/employees/search/'.urlencode($keyword).'/start_date/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="start_date") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif Start Date<a/></p></th>
                                            <th width="12%"><p><a href="{{ URL().'/employees/search/'.urlencode($keyword).'/last_name/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="last_name") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif Last Name</a></p></th>
                                            <th width="14%"><p><a href="{{ URL().'/employees/search/'.urlencode($keyword).'/first_name/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="first_name") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif First Name<a/></p></th>
                                            <th width="7%"><p><a href="{{ URL().'/employees/search/'.urlencode($keyword).'/nsn_id/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="nsn_id") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif NSN ID<a/></p></th>
                                            <th width="12%"><p>Business Line</p></th>
                                            <th width="10%"><p>Email</p></th>
                                        @else
                                            @if(Session::get('user_type')=="Root")
                                            <th width="10%"><p><span class="col-md-1 top-checkbox">{{ Form::checkbox('chk[]','',null,array("onchange"=>"toggle(this)","id"=>"checkbox1")) }}</span> Action</p></th>
                                            @else
                                            <th width="10%"><p>Action</p></th>
                                            @endif
                                            <th width="12%"><p><a href="{{ URL().'/employees/sort/employee_number/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="employee_number") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif  Employee #</p></th>
                                            <th width="10%"><p><a href="{{ URL().'/employees/sort/status/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="status") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif Status</p></th>
                                            <th width="13%"><p><a href="{{ URL().'/employees/sort/start_date/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="start_date") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif Start Date<a/></p></th>
                                            <th width="12%"><p><a href="{{ URL().'/employees/sort/last_name/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="last_name") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif Last Name</a></p></th>
                                            <th width="14%"><p><a href="{{ URL().'/employees/sort/first_name/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="first_name") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif First Name<a/></p></th>
                                            <th width="7%"><p><a href="{{ URL().'/employees/sort/nsn_id/' }}{{ $order=='asc' ? 'desc':'asc'  }}">@if($sortby=="nsn_id") @if($order=="asc") <i class="fa fa-toggle-up"> @else <i class="fa fa-toggle-down">@endif</i> @else <i class="fa fa-square-o"></i> @endif NSN ID<a/></p></th>
                                            <th width="12%"><p>Business Line</p></th>
                                            <th width="10%"><p>Email</p></th>
                                        @endif
                                        </tr>
