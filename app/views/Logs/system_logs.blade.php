...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>@if(Session::get("user_type")=="User") Employees Logs @else System Logs @endif | Vault</title>
            ...
            <div class="main_contain">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                    	...
                    	<h5>@if(Session::get("user_type")=="User") Employees Logs @else System Logs @endif</h5>
                    	</div>
		                ...
		                @endif
                        {{ Form::open(array("method"=>"get","url"=>"logs/system/filter")) }}
                            <div class="form-group">
                                <table class="table table-condensed table-striped table-hover" style="margin:auto;width:1000px">
                                    <thead>
                                        <tr>
                                            <th width="25%"></th>
                                            <th width="25%"></th>
                         ...
                         <div class="pagination center">
                             @if($userLogs->links()!=null)
                                {{ $userLogs->appends(Input::except('token'))->links() }}
                             @endif
                         </div>
                    </div>
                </div>
