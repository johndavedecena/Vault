...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>IP Assets Logs | Vault</title>
            ...
            <div class="main_contain">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
		                ...
		                @endif
                        {{ Form::open(array("method"=>"get","url"=>"logs/ipassets/filter")) }}
                         ...
                         <div class="pagination center">
                             @if($IPAssetsLogs->links()!=null)
                                {{ $IPAssetsLogs->appends(Input::except('token'))->links() }}
                             @endif
                         </div>
                    </div>
                </div>
