...
<head>
    <meta charset="utf-8">
    <title>Add Software Type | Vault</title>
        ...
        <div class="main_contain">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <h5>Add Software Type</h5>
                        @if(Session::get('message'))
                        <div class="alert alert-danger alert-dismissible text-center" role="alert">
                            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            <strong>Software Type Registration Failed. </strong> {{ Session::get('message') }}
                        </div>
                        @endif
                        @if(Session::get('success'))
                        <div class="alert alert-success alert-dismissible text-center" role="alert">
                            <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            <strong>Software Type Registration Successful. </strong> {{ htmlentities(Session::get('success')) }}
                        </div>
                        @endif
                        @if(Session::get('info'))
                        ...
                        @endif
                    {{ Form::open(array("url"=>"settings/assets/submitnewsoftwaretype","method"=>"post")) }}
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm">
                                                ...
                                                {{ Form::text('name','',array("class"=>"form-control","placeholder"=>"Software Type Name")) }}
                                            </div>
                                        </td>
                                        <td></td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{ Form::button('Submit',array("class"=>"fright btn btn-sm btn-info",'onclick'=>"return confirm('Add a new software type?')","type"=>"submit")) }}
                                        </td>
                                        <td></td>
                                    </tr>
                                </tbody>
