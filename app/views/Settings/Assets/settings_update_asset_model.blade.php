...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Update Asset Model | Vault</title>
            ...
            <div class="main_contain">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <h5>Update Asset Model</h5>
                            @if(Session::get('message'))
                            <div class="alert alert-danger alert-dismissible text-center" role="alert">
                                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <strong>Asset Model Update Failed. </strong> {{ Session::get('message') }}
                            </div>
                            @endif
                            @if(Session::get('success'))
                            <div class="alert alert-success alert-dismissible text-center" role="alert">
                                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                <strong>Asset Model Update Successful. </strong> {{ htmlentities(Session::get('success')) }}
                            </div>
                            @endif
                            @if(Session::get('info'))
                            ...
                            @endif
                        {{ Form::open(array("method"=>"post","url"=>URL('settings/assets/submitassetmodelupdate'))) }}
		                {{ Form::hidden('id',$assetModel->id) }}
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    {{ Form::text('name',$assetModel->name,array("class"=>"form-control","placeholder"=>"Asset Model Name")) }}
                                                </div>
                                            </td>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ Form::button('Submit',array("class"=>"fright btn btn-sm btn-info",'onclick'=>"return confirm('Update asset model?')","type"=>"submit")) }}
                                            </td>
                                            <td></td>
                                        </tr>
                                    </tbody>
