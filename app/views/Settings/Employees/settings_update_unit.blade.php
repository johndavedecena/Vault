                ...
                <div class="panel panel-default">
                    <div class="panel-body">
		            	...
		            	<div class="alert alert-danger alert-dismissible text-center" role="alert">
			                ...
			                <strong>Unit Update Failed. </strong> {{ Session::get('message') }}
		                </div>
		                @endif
		                @if(Session::get('success'))
		            	<div class="alert alert-success alert-dismissible text-center" role="alert">
			                <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
			                <strong>Unit Update Successful. </strong> {{ htmlentities(Session::get('success')) }}
		                </div>
		                @endif
		                @if(Session::get('info'))
		                ...
		                @endif
		                {{ Form::open(array("method"=>"post","url"=>URL('settings/employees/submitunitupdate'))) }}
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    {{ Form::text('name',$unit->name,array("class"=>"form-control","placeholder"=>"Unit Name")) }}
                                                </div>
                                            </td>
                                            <td></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><div class="input-group input-group-sm">
                                                    <span class="input-group-addon">>></span>
                                                    {{ Form::select('business_line',$businessLines,$unit->businessline_id,array('class'=>'form-control input-sm','id'=>'businessLine',"onchange"=>"unitChanger()")) }}
                                                </div>
                                            </td>
                                            <td></td>
                                        </tr>
