...
<head>
    <meta charset="utf-8">
    <title>Network Asset Logs | Vault</title>
...
<script>
    function filterLogs(){
            ...
            if(transaction=="all"){
                parent.location="{{ URL() }}/assets/network/logs/{{ $asset->id }}";}
            else{ 
                parent.location="{{ URL() }}/assets/network/logs/{{ $asset->id }}/"+transaction;}
    }
</script>
</body>
</html>