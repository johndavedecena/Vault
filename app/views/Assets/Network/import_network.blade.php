                ...
                <div class="panel-body">
                    <div class="tab-content">
                        <div class="tab-pane active">
                            <h5 class="in-line">Import Network Assets <a class="text-small" href="{{ URL() }}/forms/import_network_assets.xlsx">(Download Form)</a> </h5>
                            ...
                            @endif
                            {{ Form::open(array("url"=>"assets/network/postimport","method"=>"post","files"=>true)) }} 
