...
<head>
    <meta charset="utf-8">
    <title>Client Asset Logs | Vault</title>
        ...
        <div class="main_contain">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    @endif
                    <h5>Client Asset Logs ({{$asset->asset_tag}})</h5>
...
<script>
    function filterLogs(){
            ...
            if(transaction=="all"){
                parent.location="{{ URL() }}/assets/client/logs/{{ $asset->id }}";}
            else{ 
                parent.location="{{ URL() }}/assets/client/logs/{{ $asset->id }}/"+transaction;}
    }
</script>
</body>
</html>