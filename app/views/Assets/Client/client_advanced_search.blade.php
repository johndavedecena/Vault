<?php Session::put('page',URL("assets/client/advancedsearch")."?page=".Input::get('page')); ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
    <title>Client Assets Advanced Search | Vault</title>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active">    
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <!-- advanced search -->
                                    {{ Form::open(array("url"=>URL("assets/client/advancedsearch/search"),"method"=>"get","class"=>"form-horizontal")) }}
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-5 control-label">Employee Status</label>
                                            <div class="col-sm-7 input-group-sm">
                                                {{ Form::select("employee_status", array(
                                                                                                    ""=>"--Select--",
                                                                                                    "On-Board"=>"On-Board",
                                                                                                    "OJT"=>"OJT",
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-5 control-label">Employee Start Date</label>
                                            <div class="col-sm-7 input-group-sm">
                                                {{ Form::text("employee_start_date",'',array("class"=>"form-control","id"=>"emp-datepicker","placeholder"=>"Employee Start Date")) }}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-7 input-group-sm">
                                                {{
                                                    Form::select("asset_status",array(
                                                            ...
                                                            "Test Case"=>"Test Case"),'',array("class"=>"form-control"));
