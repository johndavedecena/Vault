...
<head>
    <meta charset="utf-8">
    <title>Software Asset Logs | Vault</title>
...
<script>
    function filterLogs(){
            ...
            if(transaction=="all"){
                parent.location="{{ URL() }}/assets/software/logs/{{ $software->id }}";}
            else{ 
                parent.location="{{ URL() }}/assets/software/logs/{{ $software->id }}/"+transaction;}
    }
</script>
</body>
</html>