 ...
 */
	...
	public function index(){
		...
		}else if(Session::has('username') && Session::get('user_class')=="IT"){
			if(Session::get('user_type')=="Admin"){
				return Redirect::to('accounts');
			}else if(Session::get('user_type')=="User"){
				return Redirect::to('assets/IT');
			}
		}else if(Session::has('username') && Session::get('user_class')=="LAB"){
			if(Session::get('user_type')=="Admin"){
				return Redirect::to('accounts');
			}else if(Session::get('user_type')=="User"){
				return Redirect::to('assets/LAB');
			}
		}else{
