...
Route::post('accounts/submitaddaccount','AccountController@submitNewAccount');
...
Route::get("assets/IT", function(){ return Redirect::to('assets/client/view/laptops'); });
Route::get("assets/LAB", function(){ return Redirect::to('assets/client/view/laptops'); });
...
Route::get("assets/geninfo", "LABController@index");
